...
// ../.wrangler/tmp/bundle-z3mQJP/checked-fetch.js
...
// api/scrape.ts
var fetchWithTimeout = /* @__PURE__ */ __name(async (url, options = {}, timeout = 8e3) => {
        ...
        if (gqlRes.ok) {
          ...
          if (print) {
            ...
            if (print.tags && Array.isArray(print.tags)) {
              data.tags = print.tags.map((t) => t.name);
            }
            success = true;
            source = "graphql";
          }
  ...
  try {
    ...
    for (const part of parts) {
      if (!part.title || !part.platform?.length || !part.typeOfPart?.length || !part.externalUrl) {
        return new Response(JSON.stringify({ error: `Part "${part.title || "Unknown"}" is missing required fields.` }), { status: 400 });
      }
    }
...
// ../.wrangler/tmp/pages-MR3rAj/functionsRoutes-0.12950695590030992.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-z3mQJP/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-z3mQJP/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.40797886058144583.mjs.map
